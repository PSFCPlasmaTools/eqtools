...
class EqdskReader(Equilibrium):
    ...
    def rz2psi(self,R,Z,*args,**kwargs):
        ...
        Args:
            ...
            * **\*args** - Slot for time input for consistent syntax with parent 
                class implementation :py:meth:`Equilibrium.rz2psi`.
        """
    ...
    def rz2phinorm(self,R,Z,*args,**kwargs):
        ...
        Keyword Args:
            ...
            **kwargs: Other keywords passed to :py:meth:`Equilibrium.rz2phinorm` 
                are valid, but will return dummy values (i.e. for timebase 
                keywords)
